...
static const char qt_meta_stringdata_ManageWidget[] = {
    "ManageWidget\0\0flag\0RecordState(bool)\0"
};
...
void ManageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->RecordState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ManageWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ManageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ManageWidget,
      qt_meta_data_ManageWidget, &staticMetaObjectExtraData }
};
