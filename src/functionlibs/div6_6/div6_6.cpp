...
long __stdcall div6_6::QueryInterface( const IID & iid,void **ppv )
{
...
unsigned long __stdcall div6_6::AddRef()
{
	m_csRef.lock();
	m_nRef ++;
	m_csRef.unlock();
...
unsigned long __stdcall div6_6::Release()
{
	int nRet = 0;
	m_csRef.lock();
	m_nRef -- ;
...
void div6_6::setSubWindows( QList<QWidget *> windows,int count )
{
...
void div6_6::setParentWindow( QWidget * parent )
{
...
void div6_6::parentWindowResize( QResizeEvent *ev )
{
...
QString div6_6::getModeName()
{
	return QString("div5_5");
}

void div6_6::subWindowDblClick( QWidget *subWindow,QMouseEvent * ev )
{
	Q_UNUSED(ev);
	int j ;
