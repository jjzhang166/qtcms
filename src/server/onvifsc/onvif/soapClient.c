...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.10 2014-10-14 12:21:03 GMT")
...
{	struct __dn__Hello soap_tmp___dn__Hello;
	struct __dn__HelloResponse *soap_tmp___dn__HelloResponse;
	if (!soap_action)
	...
	if (!dn__HelloResponse)
		return soap_closesock(soap);
	soap_default_wsdd10__ResolveType(soap, dn__HelloResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp___dn__HelloResponse = soap_get___dn__HelloResponse(soap, NULL, "-dn:HelloResponse", "wsdd10:ResolveType");
	if (soap->error)
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (dn__HelloResponse && soap_tmp___dn__HelloResponse->dn__HelloResponse)
		*dn__HelloResponse = *soap_tmp___dn__HelloResponse->dn__HelloResponse;
	return soap_closesock(soap);
}
...
{	struct __dn__Bye soap_tmp___dn__Bye;
	struct __dn__ByeResponse *soap_tmp___dn__ByeResponse;
	if (!soap_action)
	...
	if (!dn__ByeResponse)
		return soap_closesock(soap);
	soap_default_wsdd10__ResolveType(soap, dn__ByeResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp___dn__ByeResponse = soap_get___dn__ByeResponse(soap, NULL, "-dn:ByeResponse", "wsdd10:ResolveType");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (dn__ByeResponse && soap_tmp___dn__ByeResponse->dn__ByeResponse)
		*dn__ByeResponse = *soap_tmp___dn__ByeResponse->dn__ByeResponse;
	return soap_closesock(soap);
}
...
{	struct __dn__Probe soap_tmp___dn__Probe;
	struct __dn__ProbeResponse *soap_tmp___dn__ProbeResponse;
	if (!soap_action)
	...
	if (!dn__ProbeResponse)
		return soap_closesock(soap);
	soap_default_wsdd10__ProbeMatchesType(soap, dn__ProbeResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp___dn__ProbeResponse = soap_get___dn__ProbeResponse(soap, NULL, "-dn:ProbeResponse", "wsdd10:ProbeMatchesType");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (dn__ProbeResponse && soap_tmp___dn__ProbeResponse->dn__ProbeResponse)
		*dn__ProbeResponse = *soap_tmp___dn__ProbeResponse->dn__ProbeResponse;
	return soap_closesock(soap);
}
...
{	struct __tan__GetSupportedRules_ soap_tmp___tan__GetSupportedRules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedRules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__GetSupportedRules_.tan__GetSupportedRules = tan__GetSupportedRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__GetSupportedRules_(soap, &soap_tmp___tan__GetSupportedRules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__GetSupportedRules_(soap, &soap_tmp___tan__GetSupportedRules_, "-tan:GetSupportedRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__CreateRules_ soap_tmp___tan__CreateRules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateRules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__CreateRules_.tan__CreateRules = tan__CreateRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__CreateRules_(soap, &soap_tmp___tan__CreateRules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__CreateRules_(soap, &soap_tmp___tan__CreateRules_, "-tan:CreateRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__DeleteRules_ soap_tmp___tan__DeleteRules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteRules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__DeleteRules_.tan__DeleteRules = tan__DeleteRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__DeleteRules_(soap, &soap_tmp___tan__DeleteRules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__DeleteRules_(soap, &soap_tmp___tan__DeleteRules_, "-tan:DeleteRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__GetRules_ soap_tmp___tan__GetRules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetRules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__GetRules_.tan__GetRules = tan__GetRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__GetRules_(soap, &soap_tmp___tan__GetRules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__GetRules_(soap, &soap_tmp___tan__GetRules_, "-tan:GetRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__ModifyRules_ soap_tmp___tan__ModifyRules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyRules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__ModifyRules_.tan__ModifyRules = tan__ModifyRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__ModifyRules_(soap, &soap_tmp___tan__ModifyRules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__ModifyRules_(soap, &soap_tmp___tan__ModifyRules_, "-tan:ModifyRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__GetServiceCapabilities_ soap_tmp___tan__GetServiceCapabilities_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetServiceCapabilities";
	soap->encodingStyle = NULL;
	soap_tmp___tan__GetServiceCapabilities_.tan__GetServiceCapabilities = tan__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__GetServiceCapabilities_(soap, &soap_tmp___tan__GetServiceCapabilities_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__GetServiceCapabilities_(soap, &soap_tmp___tan__GetServiceCapabilities_, "-tan:GetServiceCapabilities", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__GetSupportedAnalyticsModules_ soap_tmp___tan__GetSupportedAnalyticsModules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__GetSupportedAnalyticsModules_.tan__GetSupportedAnalyticsModules = tan__GetSupportedAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__GetSupportedAnalyticsModules_(soap, &soap_tmp___tan__GetSupportedAnalyticsModules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__GetSupportedAnalyticsModules_(soap, &soap_tmp___tan__GetSupportedAnalyticsModules_, "-tan:GetSupportedAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__CreateAnalyticsModules_ soap_tmp___tan__CreateAnalyticsModules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__CreateAnalyticsModules_.tan__CreateAnalyticsModules = tan__CreateAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__CreateAnalyticsModules_(soap, &soap_tmp___tan__CreateAnalyticsModules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__CreateAnalyticsModules_(soap, &soap_tmp___tan__CreateAnalyticsModules_, "-tan:CreateAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__DeleteAnalyticsModules_ soap_tmp___tan__DeleteAnalyticsModules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__DeleteAnalyticsModules_.tan__DeleteAnalyticsModules = tan__DeleteAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__DeleteAnalyticsModules_(soap, &soap_tmp___tan__DeleteAnalyticsModules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__DeleteAnalyticsModules_(soap, &soap_tmp___tan__DeleteAnalyticsModules_, "-tan:DeleteAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__GetAnalyticsModules_ soap_tmp___tan__GetAnalyticsModules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__GetAnalyticsModules_.tan__GetAnalyticsModules = tan__GetAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__GetAnalyticsModules_(soap, &soap_tmp___tan__GetAnalyticsModules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__GetAnalyticsModules_(soap, &soap_tmp___tan__GetAnalyticsModules_, "-tan:GetAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tan__ModifyAnalyticsModules_ soap_tmp___tan__ModifyAnalyticsModules_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___tan__ModifyAnalyticsModules_.tan__ModifyAnalyticsModules = tan__ModifyAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tan__ModifyAnalyticsModules_(soap, &soap_tmp___tan__ModifyAnalyticsModules_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tan__ModifyAnalyticsModules_(soap, &soap_tmp___tan__ModifyAnalyticsModules_, "-tan:ModifyAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__PullMessages_ soap_tmp___tev__PullMessages_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/PullMessagesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__PullMessages_.tev__PullMessages = tev__PullMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__PullMessages_(soap, &soap_tmp___tev__PullMessages_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__PullMessages_(soap, &soap_tmp___tev__PullMessages_, "-tev:PullMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Seek_ soap_tmp___tev__Seek_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SeekRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Seek_.tev__Seek = tev__Seek;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Seek_(soap, &soap_tmp___tev__Seek_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Seek_(soap, &soap_tmp___tev__Seek_, "-tev:Seek", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__SetSynchronizationPoint_ soap_tmp___tev__SetSynchronizationPoint_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SetSynchronizationPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__SetSynchronizationPoint_.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__SetSynchronizationPoint_(soap, &soap_tmp___tev__SetSynchronizationPoint_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__SetSynchronizationPoint_(soap, &soap_tmp___tev__SetSynchronizationPoint_, "-tev:SetSynchronizationPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__GetServiceCapabilities_ soap_tmp___tev__GetServiceCapabilities_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetServiceCapabilities";
	soap->encodingStyle = NULL;
	soap_tmp___tev__GetServiceCapabilities_.tev__GetServiceCapabilities = tev__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__GetServiceCapabilities_(soap, &soap_tmp___tev__GetServiceCapabilities_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__GetServiceCapabilities_(soap, &soap_tmp___tev__GetServiceCapabilities_, "-tev:GetServiceCapabilities", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__CreatePullPointSubscription_ soap_tmp___tev__CreatePullPointSubscription_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/CreatePullPointSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__CreatePullPointSubscription_.tev__CreatePullPointSubscription = tev__CreatePullPointSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__CreatePullPointSubscription_(soap, &soap_tmp___tev__CreatePullPointSubscription_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__CreatePullPointSubscription_(soap, &soap_tmp___tev__CreatePullPointSubscription_, "-tev:CreatePullPointSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__GetEventProperties_ soap_tmp___tev__GetEventProperties_;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetEventPropertiesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__GetEventProperties_.tev__GetEventProperties = tev__GetEventProperties;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__GetEventProperties_(soap, &soap_tmp___tev__GetEventProperties_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__GetEventProperties_(soap, &soap_tmp___tev__GetEventProperties_, "-tev:GetEventProperties", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Renew__ soap_tmp___tev__Renew__;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/SubscriptionManager/RenewRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Renew__.wsnt__Renew = wsnt__Renew;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Renew__(soap, &soap_tmp___tev__Renew__);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Renew__(soap, &soap_tmp___tev__Renew__, "-tev:Renew", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Subscribe_ soap_tmp___tev__Subscribe_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/SubscribeRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Subscribe_.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Subscribe_(soap, &soap_tmp___tev__Subscribe_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Subscribe_(soap, &soap_tmp___tev__Subscribe_, "-tev:Subscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__GetCurrentMessage_ soap_tmp___tev__GetCurrentMessage_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__GetCurrentMessage_.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__GetCurrentMessage_(soap, &soap_tmp___tev__GetCurrentMessage_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__GetCurrentMessage_(soap, &soap_tmp___tev__GetCurrentMessage_, "-tev:GetCurrentMessage", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Notify__ soap_tmp___tev__Notify__;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationConsumer/Notify";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Notify__.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Notify__(soap, &soap_tmp___tev__Notify__);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Notify__(soap, &soap_tmp___tev__Notify__, "-tev:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___tev__Notify__(soap, _param_11);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___tev__Notify__(soap, _param_11, "-tev:Notify", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __tev__GetMessages_ soap_tmp___tev__GetMessages_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/GetMessagesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__GetMessages_.wsnt__GetMessages = wsnt__GetMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__GetMessages_(soap, &soap_tmp___tev__GetMessages_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__GetMessages_(soap, &soap_tmp___tev__GetMessages_, "-tev:GetMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__DestroyPullPoint_ soap_tmp___tev__DestroyPullPoint_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/DestroyPullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__DestroyPullPoint_.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__DestroyPullPoint_(soap, &soap_tmp___tev__DestroyPullPoint_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__DestroyPullPoint_(soap, &soap_tmp___tev__DestroyPullPoint_, "-tev:DestroyPullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Notify___ soap_tmp___tev__Notify___;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationConsumer/Notify";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Notify___.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Notify___(soap, &soap_tmp___tev__Notify___);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Notify___(soap, &soap_tmp___tev__Notify___, "-tev:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___tev__Notify___(soap, _param_12);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___tev__Notify___(soap, _param_12, "-tev:Notify", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __tev__CreatePullPoint_ soap_tmp___tev__CreatePullPoint_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__CreatePullPoint_.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__CreatePullPoint_(soap, &soap_tmp___tev__CreatePullPoint_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__CreatePullPoint_(soap, &soap_tmp___tev__CreatePullPoint_, "-tev:CreatePullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Renew___ soap_tmp___tev__Renew___;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/SubscriptionManager/RenewRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Renew___.wsnt__Renew = wsnt__Renew;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Renew___(soap, &soap_tmp___tev__Renew___);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Renew___(soap, &soap_tmp___tev__Renew___, "-tev:Renew", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__Unsubscribe___ soap_tmp___tev__Unsubscribe___;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/SubscriptionManager/UnsubscribeRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__Unsubscribe___.wsnt__Unsubscribe = wsnt__Unsubscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__Unsubscribe___(soap, &soap_tmp___tev__Unsubscribe___);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Unsubscribe___(soap, &soap_tmp___tev__Unsubscribe___, "-tev:Unsubscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__PauseSubscription_ soap_tmp___tev__PauseSubscription_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__PauseSubscription_.wsnt__PauseSubscription = wsnt__PauseSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__PauseSubscription_(soap, &soap_tmp___tev__PauseSubscription_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__PauseSubscription_(soap, &soap_tmp___tev__PauseSubscription_, "-tev:PauseSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__ResumeSubscription_ soap_tmp___tev__ResumeSubscription_;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev__ResumeSubscription_.wsnt__ResumeSubscription = wsnt__ResumeSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev__ResumeSubscription_(soap, &soap_tmp___tev__ResumeSubscription_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__ResumeSubscription_(soap, &soap_tmp___tev__ResumeSubscription_, "-tev:ResumeSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
