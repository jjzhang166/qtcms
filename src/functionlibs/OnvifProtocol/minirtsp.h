...
*/
#define MD_TYPE_PS			(128)
#define MD_TYPE_TS			(129)
#define MD_TYPE_MPEG		(130)
#define MD_TYPE_H264		(131)
#define MD_TYPE_H265		(132)
#define MD_TYPE_ULAW		(0)
#define MD_TYPE_ALAW		(8)
#define MD_TYPE_AAC			(150)

typedef void (*fMINIRTSP_DATA_HOOK)(void *pdata, unsigned int dataSize, unsigned int timestamp,
...
/*
* minirtsp event , origin from rtsplib.h
*/
enum {
	MINIRTSP_EVENT_CONNECTED = 0,
	MINIRTSP_EVENT_DISCONNECTED,
	MINIRTSP_EVENT_DESTROYED,
	MINIRTSP_EVENT_PLAY,   // only for server
	MINIRTSP_EVENT_RECORD, // only for server
	MINIRTSP_EVENT_PAUSE, // only for server
	MINIRTSP_EVENT_DATA_RECEIVED, // only for client, lparam[OUT] is MediadataType
	MINIRTSP_EVENT_AUTH_REQUIRE,  // only for client, set username in rparam[IN] with formated "username:userpwd"
	MINIRTSP_EVENT_AUTH_FAILED,
	MINIRTSP_EVENT_RTCP_SENDER_REPORT,
	MINIRTSP_EVENT_RTCP_RECEIVER_REPORT,
...
lpMINIRTSP
MINIRTSP_server_new2(const char *sdp);
