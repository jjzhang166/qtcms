...
int DvrSearch::SendSearchMessage(QList<QUdpSocket *> socklist)
{
...
void DvrSearch::run()
{
	...
	Q_FOREACH(QHostAddress it,addressList)
	{
	...
	Q_FOREACH(QUdpSocket * s,socketList)
	{
		s->close();
		delete s;
	}
...
void DvrSearch::Recv(QList<QUdpSocket *> socketlist)
{
	Q_FOREACH(QUdpSocket * s,socketlist)
	{
