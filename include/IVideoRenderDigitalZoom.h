...
interface IVideoRenderDigitalZoom : public IPComBase
{
	...
	virtual void setRenderRect(int nStartX,int nStartY,int nEndX,int nEndY,int nWndWidth,int nWndHeight)=0;//nX,nY 开始坐标，ntEndX,inEndY为结束坐标（相对当前的屏幕）,nWndWidth,nWndHeight为屏幕的宽与高
