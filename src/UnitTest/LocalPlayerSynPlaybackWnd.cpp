...
LocalPlayerSynPlaybackWnd::LocalPlayerSynPlaybackWnd(QWidget *parent)
    : QWidget(parent),
    ui(new Ui::titleview)
{
    this->lower();
...
LocalPlayerSynPlaybackWnd::~LocalPlayerSynPlaybackWnd()
{
    delete ui;
}

void LocalPlayerSynPlaybackWnd::paintEvent( QPaintEvent * e)
{
    QPainter p(this);
    QString image;
    QColor LineColor;
